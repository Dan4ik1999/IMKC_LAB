...
### Недостатки модели:
Невозможно добавить количество ячеек.

<br>

## Вычислительные эксперименты

### 1. Влияние вероятности выпадения зеленого цвета квадрата на распределние на диаграмме

Поставим параметр probability-to-be-target-color на 20%, отследим 200 итераций
